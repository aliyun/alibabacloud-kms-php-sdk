...
class Client {
     ...
     * @param string $forceDeleteWithoutRecovery
     * @param string $recoveryWindowInDays
     * @return DeleteSecretResponse
     */
    public static function deleteSecret($client, $secretName, $forceDeleteWithoutRecovery, $recoveryWindowInDays){
    ...
    public static function main($args){
        ...
        $forceDeleteWithoutRecovery = "your forceDeleteWithoutRecovery";
        $recoveryWindowInDays = "your recoveryWindowInDays";
        $response = self::deleteSecret($client, $secretName, $forceDeleteWithoutRecovery, $recoveryWindowInDays);
