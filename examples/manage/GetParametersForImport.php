...
class Client {
     ...
     */
    public static function getParametersForImport($client, $wrappingKeySpec, $keyId, $wrappingAlgorithm){
    ...
    public static function main($args){
        ...
        $wrappingKeySpec = "your wrappingKeySpec";
        $keyId = "your keyId";
        $wrappingAlgorithm = "your wrappingAlgorithm";
        $response = self::getParametersForImport($client, $wrappingKeySpec, $keyId, $wrappingAlgorithm);
