...
class Client {
     ...
     */
    public static function getSecretValueBySharedEndpoint($client, $fetchExtendedConfig, $secretName, $versionId, $versionStage){
    ...
    public static function main($args){
        ...
        $response = self::getSecretValueBySharedEndpoint($client, $fetchExtendedConfig, $secretName, $versionId, $versionStage);
