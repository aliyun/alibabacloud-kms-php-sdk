...
class Client {
     ...
     * @param string $keyId
     * @param int $keyMaterialExpireUnix
     * @return ImportKeyMaterialResponse
     */
    public static function importKeyMaterial($client, $importToken, $encryptedKeyMaterial, $keyId, $keyMaterialExpireUnix){
    ...
    public static function main($args){
        ...
        $importToken = "your importToken";
        $encryptedKeyMaterial = "your encryptedKeyMaterial";
        $keyId = "your keyId";
        $keyMaterialExpireUnix = (int)Utils::assertAsString("your keyMaterialExpireUnix");
        $response = self::importKeyMaterial($client, $importToken, $encryptedKeyMaterial, $keyId, $keyMaterialExpireUnix);
