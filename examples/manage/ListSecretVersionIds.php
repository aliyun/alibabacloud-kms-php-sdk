...
class Client {
     ...
     * @param string $includeDeprecated
     * @param string $secretName
     * @param int $pageNumber
     * @param int $pageSize
     * @return ListSecretVersionIdsResponse
     */
    public static function listSecretVersionIds($client, $includeDeprecated, $secretName, $pageNumber, $pageSize){
    ...
    public static function main($args){
        ...
        $includeDeprecated = "your includeDeprecated";
        ...
        $response = self::listSecretVersionIds($client, $includeDeprecated, $secretName, $pageNumber, $pageSize);
