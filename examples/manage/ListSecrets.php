...
class Client {
     ...
     * @param string $fetchTags
     * @return ListSecretsResponse
     */
    public static function listSecrets($client, $pageNumber, $pageSize, $filters, $fetchTags){
    ...
    public static function main($args){
        ...
        $fetchTags = "your fetchTags";
        $response = self::listSecrets($client, $pageNumber, $pageSize, $filters, $fetchTags);
