...
class Client {
     ...
     */
    public static function scheduleKeyDeletion($client, $pendingWindowInDays, $keyId){
    ...
    public static function main($args){
        ...
        $pendingWindowInDays = (int)Utils::assertAsString("your pendingWindowInDays");
        $keyId = "your keyId";
        $response = self::scheduleKeyDeletion($client, $pendingWindowInDays, $keyId);
