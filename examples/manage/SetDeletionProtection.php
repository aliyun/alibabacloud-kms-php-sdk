...
class Client {
     ...
     * @param string $protectedResourceArn
     * @param bool $enableDeletionProtection
     * @param string $deletionProtectionDescription
     * @return SetDeletionProtectionResponse
     */
    public static function setDeletionProtection($client, $protectedResourceArn, $enableDeletionProtection, $deletionProtectionDescription){
        $request = new SetDeletionProtectionRequest([
    ...
    public static function main($args){
        ...
        $protectedResourceArn = "your protectedResourceArn";
        $enableDeletionProtection = false;
        $deletionProtectionDescription = "your deletionProtectionDescription";
        $response = self::setDeletionProtection($client, $protectedResourceArn, $enableDeletionProtection, $deletionProtectionDescription);
