...
class Client {
     ...
     */
    public static function untagResource($client, $secretName, $tagKeys, $certificateId, $keyId){
    ...
    public static function main($args){
        ...
        $tagKeys = "your tagKeys";
        $certificateId = "your certificateId";
        $keyId = "your keyId";
        $response = self::untagResource($client, $secretName, $tagKeys, $certificateId, $keyId);
