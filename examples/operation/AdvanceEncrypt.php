...
class Client {
     ...
     */
    public static function advanceEncrypt($client, $paddingMode, $aad, $keyId, $plaintext, $iv, $algorithm){
    ...
    public static function main($args){
        ...
        $response = self::advanceEncrypt($client, $paddingMode, $aad, $keyId, $plaintext, $iv, $algorithm);
