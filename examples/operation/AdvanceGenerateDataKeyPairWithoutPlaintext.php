...
class Client {
     ...
     */
    public static function advanceGenerateDataKeyPairWithoutPlaintext($client, $keyFormat, $aad, $keyId, $keyPairSpec){
        $request = new AdvanceGenerateDataKeyPairWithoutPlaintextRequest([
            "keyFormat" => $keyFormat,
            "aad" => $aad,
            "keyId" => $keyId,
            "keyPairSpec" => $keyPairSpec
        ]);
        return AdvanceGenerateDataKeyPairWithoutPlaintextResponse::fromMap(Utils::toMap($client->advanceGenerateDataKeyPairWithoutPlaintext($request)));
    }
    ...
    public static function main($args){
        ...
        $response = self::advanceGenerateDataKeyPairWithoutPlaintext($client, $keyFormat, $aad, $keyId, $keyPairSpec);
