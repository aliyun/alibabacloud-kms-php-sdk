...
class Client {
     ...
     */
    public static function decrypt($client, $paddingMode, $aad, $ciphertextBlob, $keyId, $iv, $algorithm){
        ...
        return DecryptResponse::fromMap(Utils::toMap($client->decrypt($request)));
    }
    ...
    public static function main($args){
        ...
        $response = self::decrypt($client, $paddingMode, $aad, $ciphertextBlob, $keyId, $iv, $algorithm);
